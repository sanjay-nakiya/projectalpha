                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="forupdatemodal">update categorys</h1>
                            ...
                            <div class="modal-body">
                                <div class="row p-2 mt-1">
                                    ...
                                    <div class=" viral-card text-center">
                                        ...
                                        <form class="mt-3" action="#" method="POST">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text  viral-card-2 col-3" id="category">
                                                    <h5><i class="bi bi-journal"></i> category</h5>
                                                </span>
                                                <input type="number" value="<?php echo $row['category_id']; ?>" name="id"  hidden>
                                                <input type="text" name="category" class="viral-card-1  p-2 col-8"
